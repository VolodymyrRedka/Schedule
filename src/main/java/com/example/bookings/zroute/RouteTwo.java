...
public class RouteTwo {
    ...
    @Autowired
    public RouteTwo (RouteService routeService,
    ...
    public void createRouteExample() {
        Train firstTrain = trainService.getTrainById(2L);
        if (firstTrain != null) {
            List<Long> stationIds = Arrays.asList(5L, 6L, 7L, 8L, 9L,10L,11L,12L,12L);
            LocalDateTime arrivalTimeFirst = LocalDateTime.of(2023, 6, 25, 12, 0);
